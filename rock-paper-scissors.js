...
function Reset() {
	...
	pc_choice.src = "../../pictures/other/blank.jpg";
	player_choice.src = "../../pictures/other/blank.jpg";
...
function Play(player_num) {
	...
	//dialekse "petra"
	if (pc_num == 1) pc_choice.src = "../../pictures/other/rock.jpg";
	//dialekse "psalidi"
	else if (pc_num == 2) pc_choice.src = "../../pictures/other/scissors.jpg";
	//dialekse "xarti"
	else pc_choice.src = "../../pictures/other/paper.jpg";
	
	//epilogi tou paikti
	//dialekse "petra"
	if (player_num == 1) player_choice.src = "../../pictures/other/rock.jpg";
	//dialekse "psalidi"
	else if (player_num == 2) player_choice.src = "../../pictures/other/scissors.jpg";
	//dialekse "xarti"
	else player_choice.src = "../../pictures/other/paper.jpg";
