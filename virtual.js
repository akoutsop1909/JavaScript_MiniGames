...
function GetCoordinates(e) {
	...
	if ((PosX > 23 && PosX < 62) || (PosX > 192 && PosX < 224)) {
		if (PosY > 542 && PosY < 566) {
			...
			else if (rand == 2) document.getElementById("txt").innerHTML = "Θέλεις να μου κρατήσεις το <br/>χέρι;";
			else if (rand == 3) document.getElementById("txt").innerHTML = "Τι θα 'λεγες να πάμε να πιούμε <br/>μαζί ένα ζεστό τσάι;";
			else if (rand == 4) document.getElementById("txt").innerHTML = "Θέλεις να σε ξεναγήσω στην <br/>πόλη;";
			else if (rand == 5) document.getElementById("txt").innerHTML = "Έλα για μια βόλτα στην πόλη <br/>μαζί μου, να δούμε τα <br/>αξιοθέατα.";
			else if (rand == 6) document.getElementById("txt").innerHTML = "Πάμε να πάρουμε κάτι να <br/>φάμε.";
			else if (rand == 7) document.getElementById("txt").innerHTML = "Πάμε για μπιλιάρδο το <br/>βραδάκι;";
			else if (rand == 8) document.getElementById("txt").innerHTML = "Υπάρχουν πολλά ενδιαφέροντα <br/>πράγματα που μπορούμε να <br/>κάνουμε στην πόλη.";
			else if (rand == 9) document.getElementById("txt").innerHTML = "Σου αρέσουν τα ποπ κορν; <br/>Πάμε να πάρουμε και να δούμε <br/>καμια ταινία;";
			else document.getElementById("txt").innerHTML = "Πάντα φοράω τα γάντια μου το <br/>χειμώνα.";
			Talk();
			mood += 6;
			MoodChooser();
		}
	...
	if ((PosX > 84 && PosX < 101) || (PosX > 156 && PosX < 187)) {
		if (PosY > 304 && PosY < 571) {
			...
			else if (rand == 5) document.getElementById("txt").innerHTML = "Το κασκόλ μαζί με τα γάντια και <br/>το σκουφάκι, είναι πολύ ωραία <br/>αξεσουάρ.";
	...
	if ((PosX > 34 && PosX < 69) || (PosX > 187 && PosX < 220)) {
		if (PosY > 327 && PosY < 543) {
			document.getElementById("txt").innerHTML = "Στηρίξου επάνω μου! Χε χε!";
			Talk();
	...
	if (PosX > 120 && PosX < 146) {
		if (PosY > 280 && PosY < 290) {
			document.getElementById("txt").innerHTML = "Χε χε!";
			Excited();
			mood += 20;
			if (mood > 100) mood = 100;
			document.getElementById("myBar").style.width = mood+"%";
	...
	if (PosX > 85 && PosX < 183) {
		if (PosY > 171 && PosY < 203) {
			var rand = Math.floor(Math.random() * 6) + 1;
			if (rand == 1) document.getElementById("txt").innerHTML = "Τα μαλλιά μου είναι βαμμένα <br/>κόκκινα στην κορυφή και <br/>ξυρισμένα στο πλάι.";
	...
	if (PosX > 102 && PosX < 150) {
		if (PosY > 339 && PosY < 488) {
			...
			else if (rand == 10) document.getElementById("txt").innerHTML = "Έχεις κάτι;";
	...
	if (PosX > 114 && PosX < 149) {
		if (PosY > 497 && PosY < 513) {
			...
			else if (rand == 3) document.getElementById("txt").innerHTML = "Αυτή η ζώνη είναι υφασμάτινη.";
			else if (rand == 4) document.getElementById("txt").innerHTML = "Η αγκράφα της ζώνης μου είναι <br/>μεταλλική.";
	...
	if (PosX > 129 && PosX < 138) {
		if (PosY > 255 && PosY < 270) {
			if (mood > 35) {
				...
				else if (rand == 3) document.getElementById("txt").innerHTML = "Άσε τη μύτη μου στην ησυχία <br/>της!";
...
function StandBy() {
    document.getElementById("img").src = "../pictures/VirtualMe/StandBy.gif";
}

function AngryStandBy() {
    document.getElementById("img").src = "../pictures/VirtualMe/AngryStandBy.gif";
}
	
function Talk() {
    document.getElementById("img").src = "../pictures/VirtualMe/Talk.gif";
}

function Angry() {
    document.getElementById("img").src = "../pictures/VirtualMe/Angry.gif";
}

function Pain() {
    document.getElementById("img").src = "../pictures/VirtualMe/Pain.gif";
}

function Excited() {
    document.getElementById("img").src = "../pictures/VirtualMe/Excited.gif";
}
...
function NoMood() {
	Angry(); 
	document.getElementById("txt").innerHTML = "Δεν έχω διάθεση για κουβέντα."; 
	setTimeout(AngryStandBy, 1800);
}
...
//an ton exei idi xairetisei mia fora, to FG pairnei ginetai false kai o xaraktiras xairetaei allios ton xristi
var FG = true;
function Greeting() {
	if (mood > 35) {
		if (FG) {
			document.getElementById("txt").innerHTML = "Γεια σου! Σου εύχομαι να <br/> είσαι πάντα καλά!";
			Talk();
			setTimeout(StandBy, 1800);
			setTimeout(Talk, 2900);
			setTimeout(Wait, 2900);
			setTimeout(StandBy, 4700);
			FG = false;
		}
		else {
			document.getElementById("txt").innerHTML = "Γεια σου και πάλι!";
			Talk();
			setTimeout(StandBy, 1100);
			setTimeout(Talk, 2200);
...
function About() {
	if (mood > 35) {
		...
		if (rand == 1) document.getElementById("txt").innerHTML = "Μου αρέσει ο προγραμματι- <br/>σμός.";
		else if (rand == 2) document.getElementById("txt").innerHTML = "Μου αρέσει να φοράω το <br/>κασκόλ μου και τα γάντια μου.";
		else  if (rand == 3) document.getElementById("txt").innerHTML = "Μου αρέσει να βλέπω χιόνι <br/>το χειμώνα.";
		else  if (rand == 4) document.getElementById("txt").innerHTML = "Μου αρέσει να παίζω ping <br/>pong και μπιλιάρδο.";
		else  if (rand == 5) document.getElementById("txt").innerHTML = "Μου αρέσει να παρακολουθώ <br/>διάφορες ομιλίες και διαλέξεις.";
		else  if (rand == 6) document.getElementById("txt").innerHTML = "Έχω συλλογή από <br/>γραμματόσημα.";
		else  if (rand == 7) document.getElementById("txt").innerHTML = "Δεν τα πάω και πολύ καλά με <br/>τη ζωγραφική, αλλά όταν έχω <br/>έμπνευση, δημιουργώ.";
		else  if (rand == 8) document.getElementById("txt").innerHTML = "Ποτέ δε χάνω την ευκαιρία να <br/>εξερευνώ καινούργια μέρη.";
		else  if (rand == 9) document.getElementById("txt").innerHTML = "Μου αρέσει η ιαπωνική <br/>κουλτούρα και η κινέζικη <br/>κουζίνα.";
		else  if (rand == 10) document.getElementById("txt").innerHTML = "Βλέπω άνιμε.";
		else  if (rand == 11) document.getElementById("txt").innerHTML = "Μου αρέσει η γιορτινή <br/>ατμόσφαιρα των <br/>Χριστουγέννων.";
		else  if (rand == 12) document.getElementById("txt").innerHTML = "Είχα ένα καναρίνι.";
		else  if (rand == 13) document.getElementById("txt").innerHTML = "Είχα δύο πάπιες στο χωριό.";
		else  if (rand == 14) document.getElementById("txt").innerHTML = "Το μπλε είναι το αγαπημένο <br/>μου χρώμα.";
		else  if (rand == 15) document.getElementById("txt").innerHTML = "Κάνω υγιεινή διατροφή.";
		else  if (rand == 16) document.getElementById("txt").innerHTML = "Ακούω ποπ μουσική.";
		else  if (rand == 17) document.getElementById("txt").innerHTML = "Μου αρέσει να φτιάχνω </br>παιχνίδια.";
		else  document.getElementById("txt").innerHTML = "Έχω πράσινη ζώνη στο tae <br/>kwon do.";
		Talk();
		MoodChooser();
		}
	else NoMood();
...
function Paroimia() {
	if (mood > 35) {
		...
		else  if (rand == 3) document.getElementById("txt").innerHTML = "Η&nbspκαλή μέρα απ’ το πρωί <br/>φαίνεται.";
		else  if (rand == 4) document.getElementById("txt").innerHTML = "Ο&nbspύπνος θρέφει τα μωρά κι ο <br>ήλιος τα μοσχάρια.";
		...
		else  if (rand == 16) document.getElementById("txt").innerHTML = "Τα ίδια Παντελάκη μου, τα ίδια <br/>Παντελή μου.";
		else  if (rand == 17) document.getElementById("txt").innerHTML = "Ήρθαν τα’ άγρια να διώξουν τα <br/>ήμερα.";
		...
		else  if (rand == 36) document.getElementById("txt").innerHTML = "Από την πόλη έρχομαι και στην <br/>κορυφή κανέλα.";
		else  if (rand == 37) document.getElementById("txt").innerHTML = "Των φρονίμων τα παιδιά πριν <br/>πεινάσουν μαγειρεύουν.";
